...
Looking for new grad **SWE roles** in backend, platform, or AI-focused teams.
...
**Backend & Web**
`Spring Boot` `Node.js` `React` `Next.js` `GraphQL` `REST`
...
`Kafka` `RabbitMQ` `Prometheus` `Kibana` `GitHub Actions` `Jenkins`
